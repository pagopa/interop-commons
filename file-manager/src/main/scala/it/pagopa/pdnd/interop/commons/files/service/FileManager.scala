...
trait FileManager {
  ...
  /** Stores the specified file in a unique location
    ...
    */
  def store(containerPath: String)(resourceId: UUID, fileParts: (FileInfo, File)): Future[StorageFilePath]
  ...
  /** Copies the specified file in the defined location
    ...
    */
  def copy(containerPath: String)(filePathToCopy: String, resourceId: UUID, fileName: String): Future[StorageFilePath]
