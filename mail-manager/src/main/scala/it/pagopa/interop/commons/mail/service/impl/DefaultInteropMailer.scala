...
import courier._
import it.pagopa.interop.commons.mail.model.MailData
import it.pagopa.interop.commons.mail.service.{MailerInstance, InteropMailer}

import javax.mail.internet.InternetAddress
import scala.concurrent.Future
import scala.util.Try

trait DefaultInteropMailer extends InteropMailer { mailerInstance: MailerInstance =>
